({
  doInit: function(component, event) {      
      ...
      var action = component.get("c.getListDelays");      
      action.setParams({
        "curTime" : date
      });   
      action.setCallback(this, function(response) {
          ...
          if (state === "SUCCESS") {            
            ...
            console.log("\n\n\nresult delays\n\n");
            console.log({ amountDelaysToday: res.amountToday, amountDelays7Days: res.amountWeek,  amountDelays30Days: res.amountMonth, amountDelaysAllTime: res.amountAllTime});
